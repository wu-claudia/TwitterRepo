...
<img src='http://i.imgur.com/4QXOLM6.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
* Using the Twitter API and trying to extract values for the components needed in building the MySimpleTweets app
* Understanding how to use fragments and how they communicated with activities
* Using a client that performed network requests externally
* Trying to make code more efficient and avoid redundant code
